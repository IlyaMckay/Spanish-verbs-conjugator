...
description = {'Presente indicativo': {
...
# test = {
#     'Presente indicativo': {
#         '1: Настоящее время`2: Условие "если"': {
#             'Использование 1:`Использование 2:': {
#                 '''Факты и утверждения. Не для краткосрочных процессов.`Вероятное и возможное условие, в настоящем времени и в будущем.
#                     В сочетании с предложениями в настоящем времени или в будущем.''': {
#                     'Пример:`Пример:': {
#                         'El niño no come pescado.`Ребёнок не ест рыбу (Никогда. Ему не нравится)', 
#                         'Si llueve mañana, me quedaré en casa.`Если завтра будет дождь, я останусь дома.'
#                     }
#                 }
#             }
#         }
