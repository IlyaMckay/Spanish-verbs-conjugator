...
class Conjugador:
    ...
    def filter_conjugations(conjugations, accents):
        ...
        """
        esp_to_rus_dict = {
            'Presente indicativo': 'Настоящее не краткосрочное время<br>Вероятное и возможное условие "если" (даже в будущем)',
            'Presente con Estar': 'Краткосрочный и/или постоянный процесс в настоящем времени',
            'Preterito perfecto compuestas comunes': 'Продолжающееся действие<br>Может повторяться<br>Пока нет, но ещё возможно',
            'Preterito perfecto compuestas comunes con Estar': 'Процесс за последнее время',
            'Preterito indicativo': 'Прошедшее время (совершенный вид)',
            'Imperfecto indicativo': 'Прошедшее время (несовершенный вид)<br>Часть прошедшего действия',
            'Pasado continuo': 'Процесс, во время которого что-то произошло',
            'Pluscuamperfecto compuestas comunes': 'Действие завершилось до другого момента в прошлом',
            'Preterito anterior indicativo': '"После того как"/"Когда" процесс завершился и затем последовало другое действие',
            'Pluscuamperfecto continuo': 'Процесс до другого момента в прошлом',
            'Intencion interrumpida': 'Прерванное намерение ("собирался")<br>Мысль о будущем в прошлом',
            'Imperativo afirmativo': 'Утвердительное повелительное наклонение',
            'Imperativo negativo': 'Отрицательное повелительное наклонение',
            'Cohortativo afirmativo': 'Коллективное взаимное поощрение ("Давайте сделаем!…")',
            'Cohortativo negativo': 'Коллективное взаимное непоощрение ("Давайте не будем делать!…")',
            'Futuro con Ir a': 'Будущее время (наиболее распространенная форма)<br>Удивление/недоверие/неодобрение/замешательство (о настоящем времени)',
            'Futuro indicativo': 'Будущее время (формальное)<br>Предположение о настоящем времени<br>Вероятностное будущее',
            'Preterito perfecto compuestos del subjuntivo': 'Действие будет завершено в будущем, за которым следует другое действие ("после того как"/"когда")',
            'Futuro perfecto compuestas comunes': 'Действие будет завершено до другого момента в будущем (формальное)<br>Предположение о прошлом',
            'Futuro perfecto con Ir a': 'Действие будет завершено до другого момента в будущем (наиболее распространенная форма)<br>Удивление/недоверие/неодобрение/замешательство (о прошлом)',
            'Presente subjuntivo': 'НЕ ФАКТ: Что(бы), "когда" (о будущем), "возможно"',
            'Imperfecto subjuntivo': 'НЕ ФАКТ: Что(бы) (в прошлом), "если бы" (невероятное или невозможное условие даже в будущем)',
            'Futuro subjuntivo': 'НЕ ФАКТ (только в юридических текстах): "когда" (о будущем), "если" (в будущем)',
            'Pluscuamperfecto compuestos del subjuntivo': 'УЖЕ НЕВОЗМОЖНО: "если бы" (условие, которое не исполнилось в прошлом)',
            'Condicional indicativo': 'НЕ ФАКТ: "бы" (последствие, когда условие выполняется), совет<br>Мысль о будущем в прошлом',
            'Condicional perfecto compuestas comunes': 'УЖЕ НЕВОЗМОЖНО: "бы" (последствие, которое не было выполнено в прошлом)',
            'Podria haber': 'УЖЕ НЕВОЗМОЖНО: "бы мог" (действие, которое не произошло, но было возможно в прошлом)',
            'Deberia haber': 'УЖЕ НЕВОЗМОЖНО: "бы следовало" (желаемое действие, которое не произошло)',
            'Puede haber': 'Предположение о прошлом',
